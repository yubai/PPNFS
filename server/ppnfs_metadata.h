...
struct ppnfs_metadata_t
{
    ...
    unsigned int prime;
    unsigned int c;
    char pi[(BLOCK_BIT_NR>>3) + 1]; //< Each file is accociated with a @pi, the size of pi
                                    // is greater than the size of per block
};
